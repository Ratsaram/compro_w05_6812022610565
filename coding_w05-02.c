...
int main() {
    ...
    printf("Enter your name, age, hight: "); // ข้อความให้ผู้ใช้ป้อนข้อมูลชื่อ, อายุ, และส่วนสูง
    // รับข้อมูลจากผู้ใช้ โดยใช้ %s สำหรับสตริง, %d สำหรับจำนวนเต็ม, %f สำหรับจำนวนทศนิยม
    // และใช้ & เพื่อส่งที่อยู่ของตัวแปร
    scanf("%s %d %f", name, &age, &hight); // รับข้อมูลจากผู้ใช้

    printf("Enter subject, grade, gradechar: "); // ข้อความให้ผู้ใช้ป้อนข้อมูลวิชา, เกรด, และรหัสเกรด
